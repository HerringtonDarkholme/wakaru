...
| 23 | Babel helper core | partial | `array-without-holes` helper ported and wired through the Rust runtime helper composite. Remaining helper passes: array-like, to-consumable-array, sliced-to-array, extends, object-spread, create-for-of. |
