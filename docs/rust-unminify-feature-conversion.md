...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Delete decision-tree splitting, spread helper interaction, and semantic cleanup beyond simple temp declarations. Nested conditional member chains, flattened logical guard chains, optional indirect calls, and memoized call-argument recursion are now covered. |
