...
| 32 | `un-optional-chaining` | partial | AST slice is wired for canonical Babel/SWC ternary member guards, computed members, optional direct calls, optional member calls, simple `.call` and `.apply` optional calls, simple logical `||` truthy guard chains, pure-getter identifier guards, and removal of unused temp declarations. Remaining gaps: logical `&&` truthy forms, nested decision-tree splitting, `.bind`, delete, spread helper interaction, parenthesized container parity, and semantic cleanup beyond simple temp declarations. |
...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Logical `&&` truthy forms, nested decision-tree splitting, `.bind`, delete, spread helper interaction, parenthesized container parity, and semantic cleanup beyond simple temp declarations. |
