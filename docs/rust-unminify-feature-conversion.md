...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Logical `&&` truthy forms, nested decision-tree splitting, delete, spread helper interaction, parenthesized container parity, and semantic cleanup beyond simple temp declarations. |
