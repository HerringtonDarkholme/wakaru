...
| 23 | Babel helper core | partial | `array-like` and `array-without-holes` helpers ported and wired through the Rust runtime helper composite. Remaining helper passes: to-consumable-array, sliced-to-array, extends, object-spread, create-for-of. |
