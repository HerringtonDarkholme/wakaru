...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Delete decision-tree splitting, spread helper interaction, and semantic cleanup beyond simple temp declarations. Nested conditional member chains and flattened logical guard chains are now covered. |
