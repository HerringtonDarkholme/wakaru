...
| 33 | `un-nullish-coalescing` | Full decision-tree splitting, optional-chaining interaction beyond simple expressions, and broader temp cleanup. Nested coalescing chains, negated ternary guards, and simple optional-chain logical leaves are now covered. |
