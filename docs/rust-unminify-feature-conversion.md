...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Nested logical `&&` decision-tree splitting, delete, spread helper interaction, parenthesized container parity, and semantic cleanup beyond simple temp declarations. |
