...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Delete decision-tree splitting and semantic cleanup beyond simple temp declarations. Nested conditional member chains, flattened logical guard chains, optional indirect calls, memoized call-argument recursion, and apply-array argument recursion are now covered. |
| 33 | `un-nullish-coalescing` | Full decision-tree splitting, optional-chaining interaction beyond simple expressions, and broader temp cleanup. Nested coalescing chains and negated ternary guards are now covered. |
