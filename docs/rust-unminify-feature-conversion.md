...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Nested logical/delete decision-tree splitting, spread helper interaction, parenthesized container parity, and semantic cleanup beyond simple temp declarations. |
