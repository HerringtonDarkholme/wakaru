...
| ---: | --- | --- |
| 32 | `un-optional-chaining` | Delete decision-tree splitting, spread helper interaction, and semantic cleanup beyond simple temp declarations. Nested conditional member chains, flattened logical guard chains, and optional indirect calls are now covered. |
