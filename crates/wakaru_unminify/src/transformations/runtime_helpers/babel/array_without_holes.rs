...
const MODULE_NAME: &str = "@babel/runtime/helpers/arrayWithoutHoles";
const MODULE_ESM_NAME: &str = "@babel/runtime/helpers/esm/arrayWithoutHoles";
...
pub fn transform_ast(source: &mut ParsedSourceFile) -> Result<()> {
    ...
    let mut restorer = ArrayWithoutHolesRestorer {
...
struct ArrayWithoutHolesRestorer<'a> {
    ast: AstBuilder<'a>,
    helper_locals: Vec<String>,
    processed_counts: HashMap<String, usize>,
}

impl<'a> VisitMut<'a> for ArrayWithoutHolesRestorer<'a> {
    fn visit_expression(&mut self, expression: &mut Expression<'a>) {
        walk_mut::walk_expression(self, expression);

        let Some(helper_local) = self.match_array_without_holes_call(expression) else {
            return;
        };
...
impl<'a> ArrayWithoutHolesRestorer<'a> {
    fn match_array_without_holes_call(&self, expression: &Expression<'a>) -> Option<String> {
...
mod tests {
    ...
    #[test]
    fn restores_cjs_array_without_holes_calls() {
...
",
    ...
    #[test]
    fn restores_esm_array_without_holes_calls() {
        define_ast_inline_test(transform_ast)(
            r#"
...
",
    ...
    #[test]
    fn leaves_invalid_calls_and_imports() {
        define_ast_inline_test(transform_ast)(
            r#"
var _arrayWithoutHoles = require("@babel/runtime/helpers/arrayWithoutHoles");

_arrayWithoutHoles([1,,3], 2);
